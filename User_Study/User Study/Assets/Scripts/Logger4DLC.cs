...
public class Logger4DLC : MonoBehaviour
{
    string id;
    string timeStamp;
    ...
    void Start()
    {
        ...
        rowDataTemp[1] = "Trial";
        rowDataTemp[2] = "A";
        rowDataTemp[3] = "Answer";
        rowDataTemp[4] = "Result";
        rowDataTemp[5] = "Time Spent";
    ...
    public void Log(string trial, string forceA, string ans, string res, string time)
    {
