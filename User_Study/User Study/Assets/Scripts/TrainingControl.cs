...
public class TrainingControl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (restingTimer.rTimer.TimerStart == true)
        {
            ...
            if (restingTimer.rTimer.CurrentTime < 1.5 && sendingMsgA == false)
            {
                ...
                serialController.SendSerialMessage(stimuli.ToString("0.00"));
        ...
        if (restingTimer.rTimer.TimerStart == false && isForceAStart == true)
        {
            ...
            //void
            restingTime.text = material;
            Debug.Log("A:" + material);
            isForceAStart = false;
            isForceAFinish = true;
        ...
        if (testingTimer.tTimer.TimerStart == false && teststop == true && textShown == false)
        {
            ...
            restingTime.text = "Select the material you would step into";
            textShown = true;
    ...
    public void ButtonA()
    {
        ...
        //serialController.SendSerialMessage(database.Water.ToString("0.00"));
        stimuli = database.Water;
        material = "Water";
    }
    ...
    public void ButtonB()
    {
        ...
        //serialController.SendSerialMessage(database.Air.ToString("0.00"));

        stimuli = database.Air;
        material = "Air";
    }
    ...
    public void ButtonC()
    {
        ...
        //serialController.SendSerialMessage(database.Sand.ToString("0.00"));

        stimuli = database.Sand;
        material = "Sand";
    ...
    public void ButtonD()
    {
        ...
        //serialController.SendSerialMessage(database.Mud.ToString("0.00"));

        stimuli = database.Mud;
        material = "Mud";
